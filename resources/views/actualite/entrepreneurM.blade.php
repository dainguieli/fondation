    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img  src="{{ asset('assets/img/carousels/monchamp/1.jpg') }}" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="{{ asset('assets/img/carousels/monchamp/2.jpg') }}" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="{{ asset('assets/img/carousels/monchamp/3.jpg') }}" class="d-block w-100" alt="...">
              </div>
    
              <div class="carousel-item">
                <img src="{{ asset('assets/img/carousels/monchamp/4.jpg') }}" class="d-block w-100" alt="...">
              </div>
    
              <div class="carousel-item">
                <img src="{{ asset('assets/img/carousels/monchamp/5.jpg') }}"
                 class="d-block w-100" alt="...">
              </div>
    
              <div class="carousel-item">
                <img src="{{ asset('assets/img/carousels/monchamp/6.jpg') }}" class="d-block w-100" alt="...">
              </div>
    
              <div class="carousel-item">
                <img src="{{ asset('assets/img/carousels/monchamp/7.jpg') }}" class="d-block w-100" alt="...">
              </div>
