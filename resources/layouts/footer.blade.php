        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    <h4 class="section-title text-light mb-4">Section</h4>
                    <a class="btn btn-link" style="color: #777777" href="/aboute">A Propos De Nous</a>
                    <a class="btn btn-link" style="color: #777777" href="/actualite">Actualités</a>
                    <a class="btn btn-link"style="color: #777777" href="/programmes">Programmes</a>
                    <a class="btn btn-link"style="color: #777777" href="/action">Actions</a>
                    <a class="btn btn-link" style="color: #777777"href="/benevole">Bénévole</a>
                    <a class="btn btn-link" style="color: #777777"href="/contact">Contact</a>
                </div>
            
                <div class="col-lg-4 col-md-6">
                    <h4 class="section-title text-light mb-4">Newsletter</h4>
                    <p>Abonnez-vous à la Newsletter pour ne rien manquer de nos nouvelles offres</p>
                    <div class="position-relative">
                        <input class="form-control bg-transparent w-100 py-3 ps-4 pe-5" type="text"
                            placeholder="Votre mail">
                        <button type="button"
                            class="btn bouton btn-primary py-2 position-absolute top-0 end-0 mt-2 me-2">Abonnez-vous</button>
                    </div>
                </div>
            </div>
        </div>
